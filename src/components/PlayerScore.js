    ...
    return (
        <div className={"player-score " + (isPlayerActive() ? "active" : "")}>
            <div className="d-flex justify-content-around align-items-center">
                <h4 className="text-center">{playerData.name}</h4>
            </div>
            <hr />
            <div className={"d-flex align-items-center justify-content-between " + (isRoundActive(0) ? "active" : "")}>
                <div>1:</div>
            ...
            <div className={"d-flex align-items-center justify-content-between " + (isRoundActive(1) ? "active" : "")}>
                <div>2:</div>
            ...
            <div className={"d-flex align-items-center justify-content-between " + (isRoundActive(2) ? "active" : "")}>
                <div>3:</div>
            ...
            <div className={"d-flex align-items-center justify-content-between " + (isRoundActive(3) ? "active" : "")}>
                <div>4:</div>
            ...
            <div className={"d-flex align-items-center justify-content-between " + (isRoundActive(4) ? "active" : "")}>
                <div>5:</div>
